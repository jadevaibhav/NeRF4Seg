...
class LoadImageNetSAnnotations(LoadAnnotations):
    ...
    def __call__(self, results):
        ...
        results["gt_semantic_seg"] = results["gt_semantic_seg"].astype(np.int32)
        return results
...
class ImageNetSDataset(CustomDataset):
    ...
    def __init__(self, subset=919, **kwargs):
        ...
        self.gt_seg_map_loader = (
            ...
            else LoadImageNetSAnnotations(**gt_seg_map_loader_cfg)
        )
    ...
    def pre_eval(self, preds, indices):
        ...
        for pred, index in zip(preds, indices):
            ...
            pred = mmcv.imresize(
                pred, size=(seg_map.shape[1], seg_map.shape[0]), interpolation="nearest"
            )
    ...
    def results2img(self, results, imgfile_prefix, to_label_id, indices=None):
        ...
        for result, idx in zip(results, indices):
            ...
            png_filename = osp.join(imgfile_prefix, directory, f"{basename}.png")
            ...
            if basename.split("_")[2] in self.LARGES.keys():
                result_rgb = mmcv.imresize(
                    result_rgb,
                    size=(
                        self.LARGES[basename.split("_")[2]][1],
