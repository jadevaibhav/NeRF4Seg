...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(
        ...
        *,
        ...
        if (
            not isinstance(self.downsample_label_ratio, int)
            or self.downsample_label_ratio < 0
        ):
            warnings.warn(
                "downsample_label_ratio should "
    ...
    def losses(self, seg_logit, seg_label):
        ...
        if self.downsample_label_ratio > 0:
            ...
            target_size = (
                seg_label.shape[2] // self.downsample_label_ratio,
